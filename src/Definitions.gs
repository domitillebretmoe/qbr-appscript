...
function definitionRows() {
  ...
  return [
    ...
    ['Quarter actuals', 'Logos Won (Closed Won Land / MSP, Majors)', 'Number of Closed Won opportunities of Type "Land" or "MSP" on Major accounts: logos actually landed in the quarter.', 'Opportunity.Type, StageName, Account.Major_Admin_Tag__c'],
    ...
    ['Quarter actuals', 'Top 10 Deals Won (table)', 'The quarter\'s ten largest Closed Won opportunities (any type) by Delta ARR. The title shows the Closed Won count and Sum of Delta ARR that feed Net Added ARR; with more than ten wins it reads "10 of N Closed Won shown: $shown of $total".', 'Opportunity.NACV__c, StageName'],
    ['Quarter actuals', 'Logos Won (table)', 'Closed Won "Land" / "MSP" opportunities of the quarter, largest Delta ARR first.', 'Opportunity.Type, StageName'],
    ...
    ['Owners & data quality', 'Closed Won with $0 Delta ARR', 'Closed Won Land / Expand opportunity (not a renewal, not One Time) with Delta ARR = 0: probably missing NACV.', 'Opportunity.NACV__c, Type, RecordType'],
