...
function definitionRows() {
  ...
  return [
    ...
    ['Quarter actuals', 'Revenue Goal', 'Σ Goal Value of "Net ARR" goals whose Period Start falls in the quarter, over every Salesforce team matching B1.', 'Goal__c: Goal_Type__c = "Net ARR", Value__c, Period_Start__c, Team2__c'],
    ['Quarter actuals', 'Net Added ARR', 'Σ Delta ARR of Closed Won opportunities + Σ Delta ARR of Closed Lost renewals.', 'Opportunity.NACV__c, StageName'],
    ['Quarter actuals', 'Attainment (%)', 'Net Added ARR ÷ Revenue Goal.', '—'],
    ['Quarter actuals', 'Logo Goal', 'Σ Count Value of "New Logos" goals whose Period Start falls in the quarter.', 'Goal__c: Goal_Type__c = "New Logos", Count_Value__c'],
    ['Quarter actuals', 'Logo attainment', 'Σ Expected Logo Impact of the quarter\'s opportunities on Major accounts (a churned logo counts −1).', 'Opportunity.Expected_Logo_Impact__c, Account.Major_Admin_Tag__c'],
    ['Quarter actuals', 'New logos', 'Number of Closed Won opportunities of Type "Land".', 'Opportunity.Type'],
    ['Quarter actuals', 'Downgrade ARR / #', 'Closed Won renewals with Delta ARR < 0: Σ Delta ARR and count.', 'Opportunity.NACV__c, RecordType'],
    ['Quarter actuals', 'Full churn ARR / #', 'Closed Lost renewals: Σ Delta ARR and count.', 'Opportunity.NACV__c, RecordType'],
