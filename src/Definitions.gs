...
function definitionRows() {
  ...
  return [
    ...
    ['Quarter actuals', 'NRR (%)', 'Net revenue retention = (Starting ARR + Downgrade $ + Full Churn $ + expansion) / Starting ARR, where expansion = Delta ARR of Closed Won opportunities that are not "Land" (Expand + renewal upsell).', 'ARR Ledger tab, Opportunity.NACV__c, Type'],
